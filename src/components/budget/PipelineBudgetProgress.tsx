...
interface PipelineBudgetProgressProps {
...
export function PipelineBudgetProgress({ progress, className, onComplete, budgetId, pipelineJobId, startedAtMs, onSubEventsChange }: PipelineBudgetProgressProps) {
