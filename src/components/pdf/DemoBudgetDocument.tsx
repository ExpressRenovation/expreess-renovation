    ...
    return (
        <Document>
            <Page size="A4" style={styles.page}>
                ...
                <Footer pageNumber={1} companyName={clientEmail} cif={clientEmail ? "Presupuesto" : undefined} address={clientEmail ? "Demostración Pública" : undefined} />
                <Footer pageNumber={2} companyName={clientEmail} cif={clientEmail ? "Presupuesto" : undefined} address={clientEmail ? "Demostración Pública" : undefined} />
                <Footer pageNumber={3} companyName={clientEmail} cif={clientEmail ? "Presupuesto" : undefined} address={clientEmail ? "Demostración Pública" : undefined} />
            </Page>
        </Document>
    );
};
