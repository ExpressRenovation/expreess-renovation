...
import { AIReasoningSheet } from './AIReasoningSheet';
            ...
            <div className="flex-1 min-w-[300px] p-2">
                <div className="flex flex-col gap-1">
                    ...
                    <div className="flex items-center gap-2 mt-1">
                        ...
                        {/* Show Pre-computed Candidates / AI Reasoning Button */}
                        {(hasCandidates || needsReview || item.item?.aiResolution) && (
                            <>
                                <Button
                                    variant="ghost"
                                    size="sm"
                                    className={cn(
                                        "h-5 px-2 text-[10px] font-semibold transition-all shadow-sm border",
                                        needsReview
                                           ? "bg-amber-50 text-amber-600 hover:bg-amber-100 dark:bg-amber-900/20 dark:text-amber-400 border-amber-200 dark:border-amber-900/50"
                                           : "bg-indigo-50 text-indigo-600 hover:bg-indigo-100 dark:bg-indigo-900/20 dark:text-indigo-400 border-indigo-100 dark:border-indigo-900/50"
                                    )}
                                    disabled={isReadOnly}
                                    onClick={() => setIsAiModalOpen(true)}
                                >
                                    <Wand2 className="w-3 h-3 mr-1" />
                                    Razonamiento IA / Alternativas
                                </Button>
