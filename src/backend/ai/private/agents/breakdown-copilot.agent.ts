 ...
 */
// ADAPTADO A EXPRESS: dochevi resolvía el modelo con `resolveModel('chat')` desde
// un model-registry (Vertex AI, Firestore). Express usa el plugin googleAI con el
// modelo compartido `gemini25Flash`. Se mantiene la misma feature (edición NL) con
// el stack de IA de express.
