...
class FirestorePriceBookAdapter(IVectorSearch):
    ...
    Hybrid Semantic + Keyword reranking over the price book.
    """

    def __init__(self, collection_name: str = None):
        self.db = firestore.client()
        # `price_book_items` is the collection the Next.js app writes and reads,
        # and the one migrated into this project. The older `price_book_v004`
        # holds vectors from a different embedding model and is not comparable.
